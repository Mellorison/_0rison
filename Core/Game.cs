    ...
    public class Game {
...
#if DEBUG
            try {
                Console.Title = string.Format("{0} Debug Console 0_0", title);
            }
            catch {
                // No console
            }
            Console.WriteLine("[ 0rison is running in debug mode! ]");
        ...
        //void GlobalUnhandledExceptionHandler(object sender, UnhandledExceptionEventArgs e) {
           // var ex = (Exception)e.ExceptionObject;
            ...
            //File.WriteAllText(path, ex.Message + "\r\n\r\n" + ex.StackTrace + "\r\n\r\n0rison crash log generated at " + DateTime.Now.ToString());
        //}
