...
namespace _0rison {
    ...
    public partial class Tween {
        private interface IRemoveTweens	//	Hahaha! get it?
        {
            void Remove(Tween t);
        }

        public class TweenerImpl : IRemoveTweens { // Can't stop laughing...
            static TweenerImpl() {
            ...
            void IRemoveTweens.Remove(Tween tween) { //resisting the urge....
                toRemove.Add(tween);
            }
