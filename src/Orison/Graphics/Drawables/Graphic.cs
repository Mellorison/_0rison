...
namespace Orison {
    ...
    public abstract class Graphic {
        ...
        /// <summary>
        /// The render layer this graphic belongs to. Graphics are rendered in order of their layer values.
        /// </summary>
        ...
        public Color Color {
            ...
            set {
                ...
                color = new Color(value); // 2018/2/18: testing copying the color because of a bug
        ...
        protected virtual void SFMLRender(Drawable drawable, float x = 0, float y = 0) {
            ...
            // This is really bad x_x pwahahahaha
